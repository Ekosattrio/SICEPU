<?php
// src/admin/grafik.php (atau tempat kamu ingin menyimpannya)
    ...
    <div class="content-wrapper">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div id="reportContent">
          ...
          <div class="row mt-4">
            <div class="col-12">
              <h5 class="text-center">Grafik Kepuasan Mahasiswa Fasilkom</h5>
...
<script>
  ...
  var barChart = new Chart(ctxBar, {
    type: 'bar',
    data: {
      labels: ['Laporan Masuk', 'Laporan Terverifikasi', 'Belum Ditanggapi', 'Selesai'],
      datasets: [{
  ...
  var pieChart = new Chart(ctxPie, {
    type: 'pie',
    data: {
      labels: ['Terverifikasi', 'Belum Ditanggapi', 'Selesai'],
      datasets: [{
